...
const sitemapLines = cities.map(c => `  <url><loc>https://www.barkseeker.com/cities/${c.stateSlug}-${c.citySlug}</loc><lastmod>2026-04-10</lastmod><changefreq>weekly</changefreq><priority>0.7</priority></url>`);

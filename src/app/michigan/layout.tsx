...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Michigan Dog Parks — BarkSeeker", url: "https://www.barkseeker.com/michigan", siteName: "BarkSeeker" },
  twitter: { card: "summary", title: "Michigan Dog Parks | BarkSeeker" },
  alternates: { canonical: "https://www.barkseeker.com/michigan" },
};

...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Georgia Dog Parks — BarkSeeker", url: "https://www.barkseeker.com/georgia", siteName: "BarkSeeker" },
  twitter: { card: "summary", title: "Georgia Dog Parks | BarkSeeker" },
  alternates: { canonical: "https://www.barkseeker.com/georgia" },
};

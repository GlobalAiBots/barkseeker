    ...
    <div>
      ...
      <section className="max-w-4xl mx-auto px-4 pt-10 pb-2">
        <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm mb-6">
          <h2 className="font-[Cabin] text-xl font-bold text-charcoal mb-3">Dog Parks in Washington</h2>
          <p className="text-gray-600 leading-relaxed text-sm">Washington has {stParks.length.toLocaleString()} dog parks listed on BarkSeeker, with off-leash areas, fenced parks, and dog-friendly trails across the state. Popular areas include Seattle, Spokane, and Tacoma. Whether your pup needs room to run or a safe space to socialize, you&apos;ll find a park nearby.</p>
        </div>
        <div className="bg-green-50 border border-green-200 rounded-xl p-5 mb-6">
          <h3 className="font-[Cabin] font-bold text-forest mb-3">Tips for Visiting Dog Parks in Washington</h3>
        ...
        <section className="max-w-6xl mx-auto px-4 pt-8 pb-8">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-2">
            {cityMap.slice(0, 16).map(([city, count]) => (
              <Link key={city} href={`/cities/washington-${city.toLowerCase().replace(/[^a-z0-9]+/g, "-").replace(/^-|-$/g, "")}`} className="text-left bg-white border border-gray-200 rounded-lg p-3 hover:border-forest hover:shadow-sm transition">
      ...
      <section className="max-w-4xl mx-auto px-4 py-10">
        ...
        <div className="space-y-2">
          {[
            { q: "How many dog parks are in Washington?", a: `BarkSeeker lists ${stParks.length}+ dog parks across Washington, including off-leash areas, fenced parks, and dog-friendly trails.` },
            { q: "Are dog parks in Washington free?", a: "Most dog parks in Washington are free and open to the public. Some may require a city registration tag for your dog." },
            { q: "Do I need to keep my dog on a leash at Washington dog parks?", a: "In designated off-leash dog parks, your dog can play freely within the fenced area. Outside of designated off-leash zones, Washington generally requires dogs to be leashed." },
            { q: "What should I bring to a dog park in Washington?", a: "Bring water, waste bags, a leash (even at off-leash parks), and treats. Leave food and retractable leashes at home." },

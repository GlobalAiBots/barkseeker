...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Washington Dog Parks — BarkSeeker", url: "https://barkseeker.com/washington", siteName: "BarkSeeker" },
  twitter: { card: "summary", title: "Washington Dog Parks | BarkSeeker" },
  alternates: { canonical: "https://barkseeker.com/washington" },
};

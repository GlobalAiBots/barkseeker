...
export const metadata: Metadata = {
  ...
  openGraph: { title: "When to Take Your Dog to the Vet: Warning Signs You Shouldn't Ignore", url: "https://barkseeker.com/blog/when-to-take-dog-to-vet", siteName: "BarkSeeker" },
  alternates: { canonical: "https://barkseeker.com/blog/when-to-take-dog-to-vet" },
};

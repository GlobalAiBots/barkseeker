  ...
  return (
    <article className="max-w-3xl mx-auto px-4 py-12">
      ...
      <div className="prose prose-gray max-w-none text-gray-600 leading-relaxed space-y-6">
        ...
        <p>
          <strong className="text-charcoal">A Basic First Aid Kit:</strong> Dog park play can get rough, and minor injuries happen. Keep a small pet first-aid kit in your car with gauze pads, adhesive tape, antiseptic wipes, tweezers for removing splinters or thorns, and a small bottle of saline solution for flushing dirt from eyes or wounds. You&apos;ll probably never need it, but the one time you do, you&apos;ll be grateful you had it. For a deeper dive into staying safe, read our <Link href="/blog/dog-park-safety" className="text-forest font-semibold hover:underline">dog park safety guide</Link>.
        </p>
        <p>

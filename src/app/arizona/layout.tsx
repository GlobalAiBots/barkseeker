...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Arizona Dog Parks — BarkSeeker", url: "https://www.barkseeker.com/arizona", siteName: "BarkSeeker" },
  twitter: { card: "summary", title: "Arizona Dog Parks | BarkSeeker" },
  alternates: { canonical: "https://www.barkseeker.com/arizona" },
};

...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Nevada Dog Parks — BarkSeeker", url: "https://www.barkseeker.com/nevada", siteName: "BarkSeeker" },
  twitter: { card: "summary", title: "Nevada Dog Parks | BarkSeeker" },
  alternates: { canonical: "https://www.barkseeker.com/nevada" },
};

...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Nebraska Dog Parks — BarkSeeker", url: "https://www.barkseeker.com/nebraska", siteName: "BarkSeeker" },
  twitter: { card: "summary", title: "Nebraska Dog Parks | BarkSeeker" },
  alternates: { canonical: "https://www.barkseeker.com/nebraska" },
};

...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Pennsylvania Dog Parks — BarkSeeker", url: "https://barkseeker.com/pennsylvania", siteName: "BarkSeeker" },
  twitter: { card: "summary", title: "Pennsylvania Dog Parks | BarkSeeker" },
  alternates: { canonical: "https://barkseeker.com/pennsylvania" },
};

...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Florida Dog Parks — BarkSeeker", url: "https://www.barkseeker.com/florida", siteName: "BarkSeeker" },
  twitter: { card: "summary", title: "Florida Dog Parks | BarkSeeker" },
  alternates: { canonical: "https://www.barkseeker.com/florida" },
};

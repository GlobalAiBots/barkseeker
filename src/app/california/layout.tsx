...
export const metadata: Metadata = {
  ...
  openGraph: { title: "California Dog Parks — BarkSeeker", url: "https://www.barkseeker.com/california", siteName: "BarkSeeker" },
  twitter: { card: "summary", title: "California Dog Parks | BarkSeeker" },
  alternates: { canonical: "https://www.barkseeker.com/california" },
};

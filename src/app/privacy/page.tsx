  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-16">
      ...
      <div className="space-y-6 text-gray-600 leading-relaxed text-sm">
        <p>BarkSeeker (&quot;we,&quot; &quot;us,&quot; or &quot;our&quot;) operates the website barkseeker.com. This page informs you of our policies regarding the collection, use, and disclosure of personal information when you use our site.</p>

        <h2 className="font-[Cabin] text-xl font-bold text-charcoal mt-10">Information We Collect</h2>
        <p>BarkSeeker is a free, publicly accessible dog park directory. We do not require user accounts. We may collect the following information:</p>
        <ul className="list-disc pl-6 space-y-1">
          <li><strong className="text-charcoal">Contact submissions:</strong> If you email us at hello@barkseeker.com or submit a park suggestion, we collect the information you voluntarily provide (name, email, park details).</li>
        ...
        <p>You may opt out of personalized advertising by visiting <a href="https://www.google.com/settings/ads" target="_blank" rel="noopener noreferrer" className="text-forest hover:underline">Google Ads Settings</a>. Alternatively, you can opt out of third-party vendor cookies by visiting the <a href="https://optout.networkadvertising.org/" target="_blank" rel="noopener noreferrer" className="text-forest hover:underline">Network Advertising Initiative opt-out page</a>.</p>
        <p>We may also use Google Analytics to understand how visitors use our site. Google Analytics uses cookies to collect anonymous traffic data. You can learn more about how Google uses data at <a href="https://policies.google.com/technologies/partner-sites" target="_blank" rel="noopener noreferrer" className="text-forest hover:underline">Google&apos;s partner policy page</a>.</p>
        ...
        <ul className="list-disc pl-6 space-y-1">
          <li>To provide and maintain our dog park directory</li>
        ...
        <p>Dog park locations, GPS coordinates, and amenity information are compiled from publicly available sources including Google Places API, municipal parks departments, state recreation data, and user submissions.</p>
        ...
        <p>Questions about this privacy policy? Email <a href="mailto:hello@barkseeker.com" className="text-forest hover:underline">hello@barkseeker.com</a>.</p>
      </div>
    </div>
  );
}

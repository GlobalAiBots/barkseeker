...
export const metadata: Metadata = {
  ...
  openGraph: { title: "New Mexico Dog Parks — BarkSeeker", url: "https://www.barkseeker.com/new-mexico", siteName: "BarkSeeker" },
  twitter: { card: "summary", title: "New Mexico Dog Parks | BarkSeeker" },
  alternates: { canonical: "https://www.barkseeker.com/new-mexico" },
};

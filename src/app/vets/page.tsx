...
export default function VetsDirectoryPage() {
  ...
  return (
    <div>
      ...
      <section className="max-w-4xl mx-auto px-4 pt-10 pb-2">
        <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm mb-6">
          <p className="text-gray-700 leading-relaxed">
            Looking for a vet? Browse BarkSeeker&apos;s directory of {allVets.length.toLocaleString()} veterinarians below, or read our complete guide to <a href="#choose-a-vet" className="text-forest font-semibold hover:underline">choosing the right vet for your dog &rarr;</a>
          </p>
        </div>
      </section>
      ...
      {/* EDITORIAL: How to Choose a Vet */}
      <article id="choose-a-vet" className="max-w-3xl mx-auto px-4 py-12">
        <h2 className="font-[Cabin] text-3xl md:text-4xl font-bold text-charcoal mb-4 leading-tight">How to Choose the Right Vet for Your Dog: A Complete Guide</h2>
        <div className="text-gray-700 leading-relaxed space-y-5">
          ...
          <p>This guide walks through the framework experienced dog owners and rescue organizations actually use. It covers the credentials worth checking, what AAHA accreditation means in practice, how to evaluate a practice environment in a single visit, why communication style matters more than most people realize, what reasonable cost transparency looks like, and the red flags that should send you to a different practice. Above this guide is BarkSeeker&apos;s full vet directory &mdash; over {allVets.length.toLocaleString()} veterinarians across all 50 states. Use both: the directory to find candidates, this guide to evaluate them.</p>

          <h3 className="font-[Cabin] text-2xl font-bold text-charcoal mt-10 mb-3">Why Vet Selection Matters More Than Most Owners Realize</h3>
          ...
          <h3 className="font-[Cabin] text-2xl font-bold text-charcoal mt-10 mb-3">Credentials and Specializations to Look For</h3>
          ...
          <h3 className="font-[Cabin] text-2xl font-bold text-charcoal mt-10 mb-3">AAHA Accreditation: What It Means and Why It Matters</h3>
          ...
          <h3 className="font-[Cabin] text-2xl font-bold text-charcoal mt-10 mb-3">Evaluating the Practice Environment</h3>
          ...
          <h3 className="font-[Cabin] text-2xl font-bold text-charcoal mt-10 mb-3">Communication Style: The Most Underrated Factor</h3>
          ...
          <h3 className="font-[Cabin] text-2xl font-bold text-charcoal mt-10 mb-3">Understanding Vet Costs and Pricing Transparency</h3>
          ...
          <h3 className="font-[Cabin] text-2xl font-bold text-charcoal mt-10 mb-3">Practical Steps to Find Your Match</h3>
          ...
          <h3 className="font-[Cabin] text-2xl font-bold text-charcoal mt-10 mb-3">Red Flags That Should Make You Reconsider</h3>
          ...
          <h3 className="font-[Cabin] text-2xl font-bold text-charcoal mt-10 mb-3">When to Find a New Vet</h3>
          ...
          <h3 className="font-[Cabin] text-2xl font-bold text-charcoal mt-10 mb-3">Questions to Ask Before Your First Appointment</h3>

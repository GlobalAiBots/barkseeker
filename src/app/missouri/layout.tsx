...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Missouri Dog Parks — BarkSeeker", url: "https://www.barkseeker.com/missouri", siteName: "BarkSeeker" },
  twitter: { card: "summary", title: "Missouri Dog Parks | BarkSeeker" },
  alternates: { canonical: "https://www.barkseeker.com/missouri" },
};

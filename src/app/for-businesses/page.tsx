...
const businesses = [
  { icon: "&#128054;", type: "Pet Groomers", questions: ["Do you take walk-ins?", "What are your grooming prices?", "Do you handle large breeds?"] },
  { icon: "&#127973;", type: "Veterinary Clinics", questions: ["Are you accepting new patients?", "What are your hours?", "Do you handle emergencies?"] },
  { icon: "&#128062;", type: "Doggy Daycares", questions: ["What are your daycare rates?", "Is there outdoor play?", "Do you require vaccinations?"] },
  { icon: "&#128722;", type: "Pet Stores", questions: ["Do you carry [brand]?", "What are your hours?", "Do you have live animals?"] },
  { icon: "&#127976;", type: "Hotels & Lodges", questions: ["Do you have availability?", "Is there a pool?", "What's checkout time?"] },
  { icon: "&#127860;", type: "Restaurants & Bars", questions: ["What are your hours?", "Do you have a dog-friendly patio?", "Is there live music tonight?"] },
...
export default function ForBusinessesPage() {
  return (
    <div>
      ...
      <section className="px-4 pt-8">
        <div className="max-w-5xl mx-auto rounded-xl bg-gradient-to-r from-amber-500 to-yellow-500 p-6 md:p-8 text-white shadow-lg">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
              <h2 className="text-xl md:text-2xl font-bold mb-2 font-[Cabin]">&#11088; Get Featured on BarkSeeker</h2>
      ...
      <section className="py-16 md:py-24 text-center px-4 bg-cream" style={{ backgroundImage: "radial-gradient(circle at 30% 70%, rgba(45,106,79,0.06) 0%, transparent 50%)" }}>
        ...
        <p className="text-gray-500 text-lg mt-6 max-w-xl mx-auto leading-relaxed">
          Own a pet grooming business, vet clinic, doggy daycare, or pet store? CLETUS is an AI chat and voice agent for your website and phone. Works for any business, any industry. Less than $1/day.
        </p>
        <div className="flex gap-3 justify-center mt-8 flex-wrap">
          <a href="https://globalaibots.com/signup" target="_blank" rel="noopener noreferrer" className="bg-bark hover:bg-bark-dark text-white font-bold px-6 py-3 rounded-lg transition shadow-sm">Start Free 14-Day Trial</a>
          <a href="#see-it" className="border-2 border-forest text-forest hover:bg-forest hover:text-white font-bold px-6 py-3 rounded-lg transition">See It In Action</a>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              <div key={s.step} className="text-center">
                <div className="w-12 h-12 rounded-full bg-forest text-white font-bold text-xl flex items-center justify-center mx-auto mb-3">{s.step}</div>
      ...
      <section className="max-w-4xl mx-auto px-4 py-14">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {[
            ...
            <div key={p.name} className={`rounded-xl p-6 text-center ${p.highlight ? "bg-forest text-white" : "bg-white border border-gray-200 shadow-sm"}`}>
      ...
      <section className="py-14 px-4 text-center" style={{ backgroundImage: "radial-gradient(circle at 50% 100%, rgba(45,106,79,0.06) 0%, transparent 50%)" }}>
        ...
        <a href="https://globalaibots.com/signup" target="_blank" rel="noopener noreferrer" className="inline-block bg-bark hover:bg-bark-dark text-white font-bold px-8 py-3 rounded-lg transition shadow-sm">Start Your Free 14-Day Trial &rarr;</a>
        <p className="text-gray-400 text-xs mt-4">Questions? <a href="mailto:hello@globalaibots.com" className="text-forest hover:underline">hello@globalaibots.com</a></p>
      </section>
      ...
      <section className="px-4 pb-12">
        <div className="max-w-5xl mx-auto rounded-xl bg-gradient-to-r from-amber-500 to-yellow-500 p-6 md:p-8 text-white shadow-lg">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
              <h2 className="text-xl md:text-2xl font-bold mb-2 font-[Cabin]">&#11088; Run a grooming salon or vet clinic? Get Featured.</h2>
              <p className="text-white/90 text-sm md:text-base">

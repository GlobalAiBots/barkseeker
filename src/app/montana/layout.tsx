...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Montana Dog Parks — BarkSeeker", url: "https://www.barkseeker.com/montana", siteName: "BarkSeeker" },
  twitter: { card: "summary", title: "Montana Dog Parks | BarkSeeker" },
  alternates: { canonical: "https://www.barkseeker.com/montana" },
};

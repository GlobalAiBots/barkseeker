...
export const metadata: Metadata = {
  ...
  openGraph: { title: "New York Dog Parks — BarkSeeker", url: "https://www.barkseeker.com/new-york", siteName: "BarkSeeker" },
  twitter: { card: "summary", title: "New York Dog Parks | BarkSeeker" },
  alternates: { canonical: "https://www.barkseeker.com/new-york" },
};

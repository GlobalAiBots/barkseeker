...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Hawaii Dog Parks — BarkSeeker", url: "https://www.barkseeker.com/hawaii", siteName: "BarkSeeker" },
  twitter: { card: "summary", title: "Hawaii Dog Parks | BarkSeeker" },
  alternates: { canonical: "https://www.barkseeker.com/hawaii" },
};

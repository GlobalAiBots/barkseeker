...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Oklahoma Dog Parks — BarkSeeker", url: "https://www.barkseeker.com/oklahoma", siteName: "BarkSeeker" },
  twitter: { card: "summary", title: "Oklahoma Dog Parks | BarkSeeker" },
  alternates: { canonical: "https://www.barkseeker.com/oklahoma" },
};

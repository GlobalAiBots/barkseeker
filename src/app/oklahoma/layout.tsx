...
export const metadata: Metadata = {
  title: "Every Dog Park in Oklahoma — 24+ Parks | BarkSeeker",
  description: "The most complete dog park directory for Oklahoma. 24+ parks with GPS coordinates, amenities, and off-leash info.",

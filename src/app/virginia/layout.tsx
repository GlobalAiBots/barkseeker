...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Virginia Dog Parks — BarkSeeker", url: "https://www.barkseeker.com/virginia", siteName: "BarkSeeker" },
  twitter: { card: "summary", title: "Virginia Dog Parks | BarkSeeker" },
  alternates: { canonical: "https://www.barkseeker.com/virginia" },
};

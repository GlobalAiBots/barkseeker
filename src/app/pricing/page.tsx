...
export const metadata: Metadata = {
  title: "Pricing — Free & Featured Listings | BarkSeeker",
  description: "Compare Free and Featured listings for groomers and vets on BarkSeeker. Featured at $49.95/mo includes priority placement, photos, customer messages, and monthly reports.",
  alternates: { canonical: "https://www.barkseeker.com/pricing" },
};
...
export default function PricingPage() {
  return (
    <main className="max-w-5xl mx-auto px-4 py-12">
      ...
      <p className="text-gray-600 text-lg max-w-2xl mb-10">Every groomer and vet on BarkSeeker gets a free listing. Upgrade to Featured for priority placement and lead-generation tools.</p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <section className="rounded-2xl border border-gray-200 bg-white p-8 shadow-sm flex flex-col">
          ...
          <p className="text-gray-500 text-sm mb-6">Default for every business we&apos;ve indexed.</p>
          ...
          <a href="mailto:hello@barkseeker.com?subject=Claim%20Listing" className="inline-block text-center bg-gray-700 hover:bg-gray-800 text-white font-semibold px-6 py-3 rounded-lg transition text-sm">
        ...
        <section className="rounded-2xl border-2 border-amber-300 bg-amber-50 p-8 shadow-md flex flex-col">
          ...
          <ul className="space-y-2 text-sm text-gray-800 mb-8 flex-1">
            ...
            <li className="flex items-start gap-2"><span className="text-amber-600 flex-shrink-0 mt-0.5">&#10003;</span> Top placement on state, city, and category pages</li>
      ...
      <section className="mt-12">
        ...
        <div className="space-y-3">
          <details className="bg-white border border-gray-200 rounded-xl p-5">
            ...
            <p className="mt-2 text-gray-600 text-sm">Your business appears at the top of its state, city, and category pages with a &#11088; Featured badge. On listing cards, Featured businesses get larger presentation and a priority slot above the organic list.</p>
          </details>
          <details className="bg-white border border-gray-200 rounded-xl p-5">
          ...
          <details className="bg-white border border-gray-200 rounded-xl p-5">
            <summary className="cursor-pointer font-semibold text-charcoal">Do you verify Featured subscribers?</summary>
            <p className="mt-2 text-gray-600 text-sm">Yes. After you subscribe, we verify you&apos;re authorized to represent the business before activating Featured treatment. Usually within one business day.</p>
          </details>
          <details className="bg-white border border-gray-200 rounded-xl p-5">
            <summary className="cursor-pointer font-semibold text-charcoal">What if my business isn&apos;t listed yet?</summary>
            <p className="mt-2 text-gray-600 text-sm">Email us at hello@barkseeker.com with your business name, address, and website. We&apos;ll add you to the index, then you can claim the listing or subscribe to Featured.</p>
          </details>
        </div>
      </section>
    </main>

...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Oregon Dog Parks — BarkSeeker", url: "https://www.barkseeker.com/oregon", siteName: "BarkSeeker" },
  twitter: { card: "summary", title: "Oregon Dog Parks | BarkSeeker" },
  alternates: { canonical: "https://www.barkseeker.com/oregon" },
};

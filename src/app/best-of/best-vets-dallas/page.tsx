...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Best Vets in Dallas — Top 8", url: "https://barkseeker.com/best-of/best-vets-dallas", siteName: "BarkSeeker" },
  alternates: { canonical: "https://barkseeker.com/best-of/best-vets-dallas" },
};
    ...
    <article className="max-w-3xl mx-auto px-4 py-12">
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        itemListElement: [
          ...
          { "@type": "ListItem", position: 3, name: "Best Vets in Dallas", item: "https://barkseeker.com/best-of/best-vets-dallas" },
        ],
      }) }} />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        "@context": "https://schema.org",

...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Best Dog Groomers in Los Angeles — Top 10", url: "https://barkseeker.com/best-of/best-dog-groomers-los-angeles", siteName: "BarkSeeker" },
  alternates: { canonical: "https://barkseeker.com/best-of/best-dog-groomers-los-angeles" },
};
    ...
    <article className="max-w-3xl mx-auto px-4 py-12">
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        itemListElement: [
          ...
          { "@type": "ListItem", position: 3, name: "Best Dog Groomers in Los Angeles", item: "https://barkseeker.com/best-of/best-dog-groomers-los-angeles" },
        ],
      }) }} />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        "@context": "https://schema.org",

...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Massachusetts Dog Parks — BarkSeeker", url: "https://www.barkseeker.com/massachusetts", siteName: "BarkSeeker" },
  twitter: { card: "summary", title: "Massachusetts Dog Parks | BarkSeeker" },
  alternates: { canonical: "https://www.barkseeker.com/massachusetts" },
};

...
export const metadata: Metadata = {
  ...
  openGraph: { title: "New Jersey Dog Parks — BarkSeeker", url: "https://www.barkseeker.com/new-jersey", siteName: "BarkSeeker" },
  twitter: { card: "summary", title: "New Jersey Dog Parks | BarkSeeker" },
  alternates: { canonical: "https://www.barkseeker.com/new-jersey" },
};

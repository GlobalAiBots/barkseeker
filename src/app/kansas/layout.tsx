...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Kansas Dog Parks — BarkSeeker", url: "https://www.barkseeker.com/kansas", siteName: "BarkSeeker" },
  twitter: { card: "summary", title: "Kansas Dog Parks | BarkSeeker" },
  alternates: { canonical: "https://www.barkseeker.com/kansas" },
};

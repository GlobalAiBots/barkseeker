...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Louisiana Dog Parks — BarkSeeker", url: "https://www.barkseeker.com/louisiana", siteName: "BarkSeeker" },
  twitter: { card: "summary", title: "Louisiana Dog Parks | BarkSeeker" },
  alternates: { canonical: "https://www.barkseeker.com/louisiana" },
};

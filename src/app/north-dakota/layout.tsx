...
export const metadata: Metadata = {
  ...
  openGraph: { title: "North Dakota Dog Parks — BarkSeeker", url: "https://www.barkseeker.com/north-dakota", siteName: "BarkSeeker" },
  twitter: { card: "summary", title: "North Dakota Dog Parks | BarkSeeker" },
  alternates: { canonical: "https://www.barkseeker.com/north-dakota" },
};

  ...
  return (
    <div>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        mainEntity: [
          { "@type": "Question", name: "How many dog parks are in Alabama?", acceptedAnswer: { "@type": "Answer", text: `There are ${stParks.length} dog parks in Alabama. BarkSeeker has mapped every off-leash area and fenced park across the state.` } },
          { "@type": "Question", name: "Are dog parks in Alabama free?", acceptedAnswer: { "@type": "Answer", text: "Most dog parks in Alabama are free and open to the public. Some may require a city or county registration tag for your dog." } },
          { "@type": "Question", name: "Are there fenced dog parks in Alabama?", acceptedAnswer: { "@type": "Answer", text: "Yes, many dog parks in Alabama have fully fenced areas. Browse BarkSeeker listings to find fenced off-leash parks near you." } },
          { "@type": "Question", name: "Do dog parks in Alabama have small dog areas?", acceptedAnswer: { "@type": "Answer", text: "Many larger dog parks in Alabama have separate areas for small dogs. Check individual park listings on BarkSeeker for amenity details." } },
          { "@type": "Question", name: "How do I find dog parks near me in Alabama?", acceptedAnswer: { "@type": "Answer", text: `Use BarkSeeker to browse all ${stParks.length} dog parks in Alabama by city. Each listing includes a map and directions.` } },
        ],
      }) }} />
      ...
      <section className="max-w-4xl mx-auto px-4 pt-10 pb-2">
        <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm mb-6">
          <h2 className="font-[Cabin] text-xl font-bold text-charcoal mb-3">Dog Parks in Alabama</h2>
          <p className="text-gray-600 leading-relaxed text-sm">Alabama has {stParks.length.toLocaleString()} dog parks listed on BarkSeeker, with off-leash areas, fenced parks, and dog-friendly trails across the state. Popular areas include Birmingham, Huntsville, and Mobile. Whether your pup needs room to run or a safe space to socialize, you&apos;ll find a park nearby.</p>
        </div>
        <div className="bg-green-50 border border-green-200 rounded-xl p-5 mb-6">
          <h3 className="font-[Cabin] font-bold text-forest mb-3">Tips for Visiting Dog Parks in Alabama</h3>
        ...
        <section className="max-w-6xl mx-auto px-4 pt-8 pb-8">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-2">
            {cityMap.slice(0, 16).map(([city, count]) => (
              <Link key={city} href={`/cities/alabama-${city.toLowerCase().replace(/[^a-z0-9]+/g, "-").replace(/^-|-$/g, "")}`} className="text-left bg-white border border-gray-200 rounded-lg p-3 hover:border-forest hover:shadow-sm transition">
      ...
      <section className="max-w-4xl mx-auto px-4 py-10">
        ...
        <div className="space-y-2">
          {[
            { q: "How many dog parks are in Alabama?", a: `BarkSeeker lists ${stParks.length}+ dog parks across Alabama, including off-leash areas, fenced parks, and dog-friendly trails.` },
            { q: "Are dog parks in Alabama free?", a: "Most dog parks in Alabama are free and open to the public. Some may require a city registration tag for your dog." },
            { q: "Do I need to keep my dog on a leash at Alabama dog parks?", a: "In designated off-leash dog parks, your dog can play freely within the fenced area. Outside of designated off-leash zones, Alabama generally requires dogs to be leashed." },
            { q: "What should I bring to a dog park in Alabama?", a: "Bring water, waste bags, a leash (even at off-leash parks), and treats. Leave food and retractable leashes at home." },

...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Alabama Dog Parks — BarkSeeker", url: "https://www.barkseeker.com/alabama", siteName: "BarkSeeker" },
  twitter: { card: "summary", title: "Alabama Dog Parks | BarkSeeker" },
  alternates: { canonical: "https://www.barkseeker.com/alabama" },
};

...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Tennessee Dog Parks — BarkSeeker", url: "https://barkseeker.com/tennessee", siteName: "BarkSeeker" },
  twitter: { card: "summary", title: "Tennessee Dog Parks | BarkSeeker" },
  alternates: { canonical: "https://barkseeker.com/tennessee" },
};

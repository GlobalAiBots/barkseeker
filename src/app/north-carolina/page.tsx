...
export default function NorthCarolinaPage() {
  ...
  return (
    <div>
      ...
      <ParkList parks={stParks} stateName="North Carolina" />

      <section className="max-w-4xl mx-auto px-4 py-10">
        <h2 className="font-[Cabin] text-2xl font-bold text-charcoal mb-4">North Carolina Dog Park FAQ</h2>
        <div className="space-y-2">
          {[
            { q: "How many dog parks are in North Carolina?", a: `BarkSeeker lists ${stParks.length}+ dog parks across North Carolina.` },

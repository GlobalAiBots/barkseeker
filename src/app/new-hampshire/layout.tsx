...
export const metadata: Metadata = {
  ...
  openGraph: { title: "New Hampshire Dog Parks — BarkSeeker", url: "https://www.barkseeker.com/new-hampshire", siteName: "BarkSeeker" },
  twitter: { card: "summary", title: "New Hampshire Dog Parks | BarkSeeker" },
  alternates: { canonical: "https://www.barkseeker.com/new-hampshire" },
};

...
export default function GroomersDirectory() {
  ...
  return (
    <div>
      ...
      <section className="max-w-4xl mx-auto px-4 pt-10 pb-2">
        <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm mb-6">
          <p className="text-gray-700 leading-relaxed">
            Looking for a groomer? Browse BarkSeeker&apos;s directory of {allGroomers.length.toLocaleString()} dog groomers below, or read our complete guide to <a href="#choose-a-groomer" className="text-forest font-semibold hover:underline">choosing the right groomer for your dog &rarr;</a>
          </p>
        </div>
      </section>
      ...
      {/* EDITORIAL: How to Choose a Dog Groomer */}
      <article id="choose-a-groomer" className="max-w-3xl mx-auto px-4 py-12">
        <h2 className="font-[Cabin] text-3xl md:text-4xl font-bold text-charcoal mb-4 leading-tight">How to Choose the Right Dog Groomer: A Complete Guide</h2>
        <div className="text-gray-700 leading-relaxed space-y-5">
          ...
          <p>This guide covers what actually distinguishes good groomers from the rest: the certifications that matter, what an evaluable salon environment looks like, breed-specific expertise, fair pricing, the conversation to have on a first appointment, and the red flags that should send you elsewhere. Above this guide is BarkSeeker&apos;s directory of professional groomers across all 50 states. Use both to find someone who treats grooming as the professional service it should be &mdash; not just a haircut.</p>

          <h3 className="font-[Cabin] text-2xl font-bold text-charcoal mt-10 mb-3">Why Choosing Carefully Matters</h3>
          ...
          <h3 className="font-[Cabin] text-2xl font-bold text-charcoal mt-10 mb-3">Grooming Certifications and Training</h3>
          ...
          <h3 className="font-[Cabin] text-2xl font-bold text-charcoal mt-10 mb-3">Evaluating the Grooming Environment</h3>
          ...
          <h3 className="font-[Cabin] text-2xl font-bold text-charcoal mt-10 mb-3">Discussing Your Dog&apos;s Specific Needs</h3>
          ...
          <h3 className="font-[Cabin] text-2xl font-bold text-charcoal mt-10 mb-3">Understanding Grooming Costs</h3>
          ...
          <h3 className="font-[Cabin] text-2xl font-bold text-charcoal mt-10 mb-3">Mobile Grooming vs Salon Grooming</h3>
          ...
          <h3 className="font-[Cabin] text-2xl font-bold text-charcoal mt-10 mb-3">First-Visit Best Practices</h3>
          ...
          <h3 className="font-[Cabin] text-2xl font-bold text-charcoal mt-10 mb-3">Red Flags in a Groomer</h3>
          ...
          <h3 className="font-[Cabin] text-2xl font-bold text-charcoal mt-10 mb-3">Building a Long-Term Grooming Relationship</h3>

      ...
      <section className="my-8 rounded-2xl border-2 border-amber-300 bg-amber-50 p-6">
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            <h3 className="font-[Cabin] text-lg font-bold text-charcoal mb-1">Is this your business?</h3>
            <p className="text-sm text-gray-700 mb-4">
              Claim your listing free, or upgrade to Featured for priority placement, photos, a customer message form, and a monthly performance report. <Link href="/pricing" className="text-forest underline hover:text-forest-light">See pricing</Link>.
            </p>
            <div className="flex flex-wrap gap-3">
              <a href={`mailto:hello@barkseeker.com?subject=${encodeURIComponent(`Claim Listing: ${groomer.name}`)}&body=${encodeURIComponent(`I'd like to claim the listing for ${groomer.name} at ${groomer.address || `${groomer.city}, ${sn}`}.\n\nListing URL: https://www.barkseeker.com/groomers/${slug}\n\nPlease contact me to verify ownership.`)}`} className="inline-block bg-gray-700 hover:bg-gray-800 text-white font-semibold px-5 py-2.5 rounded-lg transition text-sm">
                Claim Free Listing
              </a>

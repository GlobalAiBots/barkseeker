...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Minnesota Dog Parks — BarkSeeker", url: "https://www.barkseeker.com/minnesota", siteName: "BarkSeeker" },
  twitter: { card: "summary", title: "Minnesota Dog Parks | BarkSeeker" },
  alternates: { canonical: "https://www.barkseeker.com/minnesota" },
};
